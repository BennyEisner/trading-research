...
class DirectionalLoss:
    """
    Custom loss functions that emphasize directional accuracy in financial predictions
    """
    ...
    def sign_prediction_loss(y_true, y_pred):
        ...
        return -tf.reduce_mean(
            y_true_prob * tf.math.log(y_pred_prob) + 
            (1 - y_true_prob) * tf.math.log(1 - y_pred_prob)
        )
