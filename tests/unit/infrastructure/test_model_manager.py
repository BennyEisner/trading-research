...
class TestModelManager:
    ...
    def mock_metadata(self):
        ...
        return {
            ...
            "config": {"tickers": ["TEST", "DEMO"], "lookback_window": 30, "epochs": 5},
    ...
    def test_list_model_names(self, model_manager):
        ...
        model_manager.models_registry = {"model1": {"name": "model1"}, "model2": {"name": "model2"}}
    ...
    def test_list_models(self, model_manager):
        ...
        model_manager.models_registry = {"model1": mock_model1, "model2": mock_model2}
    ...
    def test_clear_cache(self, model_manager):
        ...
        model_manager.models = {"model1": Mock(), "model2": Mock(), "model3": Mock()}
    ...
    def test_get_cache_stats(self, model_manager):
        ...
        model_manager.models = {"model1": Mock(), "model2": Mock()}
    ...
    def test_get_model_load_from_file(self, mock_load_model, mock_enable_unsafe, model_manager):
        ...
        model_manager.models_registry = {"test_model": {"file_path": "/fake/path/test_model.keras"}}
    ...
    def test_get_model_load_failure(self, mock_load_model, model_manager):
        ...
        model_manager.models_registry = {"failing_model": {"file_path": "/fake/path/failing_model.keras"}}
