...
class FinancialMetrics:
    ...
    @staticmethod
    def calculate_information_ratio(predicted_returns: np.ndarray, actual_returns: np.ndarray, 
    ...
    @staticmethod
    def calculate_hit_rate(predicted_returns: np.ndarray, actual_returns: np.ndarray, 
    ...
    def calculate_profit_factor(predicted_returns: np.ndarray, actual_returns: np.ndarray) -> float:
        ...
        trades = np.where(predicted_returns > 0, actual_returns, 
                         np.where(predicted_returns < 0, -actual_returns, 0))
    ...
    @classmethod
    def evaluate_trading_performance(cls, predicted_returns: np.ndarray, 
        ...
        trading_returns = np.where(predicted_returns > 0, actual_returns, 
                                 np.where(predicted_returns < 0, -actual_returns, 0))
