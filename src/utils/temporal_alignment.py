...
"""
Temporal Alignment Utilities for Multi-Ticker Data
...
class TemporalAligner:
    ...
    def align_features_data(self, ticker_features: Dict[str, pd.DataFrame]) -> Dict[str, pd.DataFrame]:
        ...
        for ticker, features in aligned_features.items():
            feature_count = len([col for col in features.columns if col not in ['date', 'open', 'high', 'low', 'close', 'volume', 'ticker', 'daily_return']])
