...
def main():
    ...
    parser.add_argument(
        ...
        help="Configuration file path (default: production_config.json)"
    )
    parser.add_argument(
        "--quick-test",
        action="store_true", 
        help="Use quick test configuration for faster iteration"
    )
    parser.add_argument(
        "--skip-tuning",
        action="store_true",
    ...
    try:
        ...
        if args.skip_tuning:
            ...
            print("⏭️  Hyperparameter tuning disabled")
