...
"""
Enhanced production training with directional focus
"""
...
from train_lstm_production import LSTMProductionTrainer
...
class DirectionalEnhancedTrainer(LSTMProductionTrainer):
    ...
    def _create_directional_config(self):
        """Create configuration optimized for directional prediction"""
        return {
            "directional_alpha": 0.4,  # 40% weight on directional component
            "learning_rate": 0.0005,  # Low LR for stable directional learning
            "batch_size": 64,  # Smaller batches for better gradient estimates
            "dropout_rate": 0.4,  # High dropout to prevent magnitude overfitting
            "l2_regularization": 0.005,  # Strong regularization
            "patience": 15,
            "monitor_metric": "val__directional_accuracy",  # Focus on directional accuracy
            "early_stopping_mode": "max",  # Higher directional accuracy is better
        }
